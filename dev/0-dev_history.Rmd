...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Toolbox for energyscape analyses",
    Description = "Estimate energyscape and biomass consumption of top predators from allometric relationships.",
    `Authors@R` = c(
...
usethis::use_import_from("stats", "rnorm")
usethis::use_import_from("ggplot2", "ggplot")
usethis::use_import_from("ggplot2", "aes")
usethis::use_import_from("ggplot2", "geom_pointrange")
usethis::use_import_from("ggplot2", "geom_col")
...
usethis::use_github_action("pkgdown")  # put the website online on a gh-pages
...
usethis::use_pkgdown() # only once !!!!

# reconstruit le site en entier
pkgdown::build_site(override = list(destination = "inst/site")) # faire dans inst/ plutot que à la racine permet que le site soit accessible en local à l'utilisateur
...
# Set Continuous Integration
usethis::use_github_action("pkgdown") # déployement en ligne du site sur une Github page via GutHub Action 
```
...
remotes::install_local(path = "~/energyscapes_0.1.0.tar.gz") # installe le package depuis le format tar.gz
```
...
usethis::use_logo(img = "man/figures/logo1.png")
```
